...
urlpatterns = [
    ...
    path('vendas/', views.venda_list, name='vendas_list'),
    path('vendas/novo/', views.venda_form, name='vendas_create'),
    path('vendas/<int:id>/', views.venda_form, name='vendas_update'),
]